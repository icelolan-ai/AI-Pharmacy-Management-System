...
| D32 | 19 ก.ย. 2026 | สิทธิ์เห็นต้นทุนในหน้าประวัติ | ประวัติการรับสินค้าที่แสดง **ต้นทุนและมูลค่ารวม** เห็นได้เฉพาะ **owner และ pharmacist** · **staff ต้องไม่เห็นเลย และให้ซ่อนทั้งคอลัมน์ ไม่ใช่แสดงเป็นขีด** · เหตุผล: pharmacist เป็นคนรับของจึงเห็นต้นทุนอยู่แล้วตอนรับ แต่ staff ไม่เคยมีเหตุต้องเห็น — สอดคล้องกับ D20 และหน้าขายที่ staff เห็นราคาขายเป็นข้อความอย่างเดียว (D11) |
